...
public class ResourceCentre {
	...
	private static final int TYPE_CHROMEBOOK = 2;
	private static final int TYPE_CAMCORDER = 1;
...
//Ijas
			...
			if (option == OPTION_VIEW) {
				...
				} else if (itemType == TYPE_CHROMEBOOK) {
					// Add Chromebook
	...
	public static boolean doLoanCamcorder(ArrayList<Camcorder> camcorderList, String tag, String dueDate) {
		...
		for (int i = 0; i < camcorderList.size(); i++) {
			...
			isLoaned = camcorderList.get(i).toLoan(tag, dueDate);
		}
		return isLoaned;
	}
	...
	public static boolean doLoanChromebook(ArrayList<Chromebook> chromebookList, String tag, String dueDate) {
		...
		for (int i = 0; i < chromebookList.size(); i++) {
			...
			isLoaned = chromebookList.get(i).toLoan(tag, dueDate);
		}
		return isLoaned;
	}
	...
	public static boolean doReturnCamcorder(ArrayList<Camcorder> camcorderList,String tag) {
		...
		for (int i = 0; i < camcorderList.size(); i++) {
			...
			isReturned = camcorderList.get(i).toReturn(tag);
		}
		return isReturned;
	...
	public static boolean doReturnChromebook(ArrayList<Chromebook> chromebookList,String tag) {
		...
		for (int i = 0; i < chromebookList.size(); i++) {
			...
			isReturned = chromebookList.get(i).toReturn(tag);
		}
		return isReturned;
